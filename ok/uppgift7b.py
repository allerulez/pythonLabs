...
"""
vikho 12/7: Ok
Hade gärna sett en mer förenklad insert_time_span då den är nästan är lite
för grötig i struktueren, ni hade tillexmepel kunnat definiera en inre hjälpfunktion
som rekursivt gått igenom och satt in sig på rätt ställe, de hade blivit renare.
"""

...
"""
vikho 20/10: Ok!
Snygg lösning, bra återanvändning av compose och repeat :)
En mindre sak att anmärka på är att smooth kan förenklas något genom användandet
av lambda:
